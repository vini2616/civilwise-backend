...
var getNotes = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Note_1.default.find({ userId: req.user._id })];
            case 1:
                notes = _a.sent();
...
var updateNote = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Note_1.default.findById(req.params.id)];
            case 1:
                note = _a.sent();
                if (!note) {
                ...
                return [4 /*yield*/, Note_1.default.findByIdAndUpdate(req.params.id, req.body, { new: true })];
            case 2:
                updatedNote = _a.sent();
