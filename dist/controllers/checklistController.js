...
exports.deleteChecklist = exports.updateChecklist = exports.createChecklist = exports.getChecklists = void 0;
...
// @access  Private
var getChecklists = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var siteId, user, hasAccess, checklists, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, Checklist_1.default.find({ siteId: siteId }).sort({ createdAt: -1 })];
            case 2:
                checklists = _a.sent();
                res.json(checklists);
                return [3 /*break*/, 4];
...
var createChecklist = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, siteId, name_1, type, category, items, status_1, date, user, hasAccess, checklist, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 5, , 6]);
                _a = req.body, siteId = _a.siteId, name_1 = _a.name, type = _a.type, category = _a.category, items = _a.items, status_1 = _a.status, date = _a.date;
                user = req.user;
            ...
            case 2:
                ...
                return [2 /*return*/];
            case 3: return [4 /*yield*/, Checklist_1.default.create({
                    siteId: siteId,
                    name: name_1,
                    type: type,
                    category: category,
...
var updateChecklist = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, user, checklist, hasAccess, updatedChecklist, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                id = req.params.id;
                user = req.user;
                return [4 /*yield*/, Checklist_1.default.findById(id)];
            case 1:
                checklist = _a.sent();
                if (!checklist) {
                ...
                return [4 /*yield*/, (0, accessControl_1.verifySiteAccess)(user, checklist.siteId.toString())];
            case 2:
                hasAccess = _a.sent();
                if (!hasAccess) {
                ...
                return [4 /*yield*/, Checklist_1.default.findByIdAndUpdate(id, req.body, { new: true })];
            case 3:
...
var deleteChecklist = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, user, checklist, hasAccess, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
            ...
            case 2:
                ...
                return [4 /*yield*/, checklist.deleteOne()];
            case 3:
                _a.sent();
