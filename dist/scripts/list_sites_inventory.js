...
var run = function () { return __awaiter(void 0, void 0, void 0, function () {
    var sites, _i, sites_1, site, count, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                sites = _a.sent();
                console.log("Found ".concat(sites.length, " sites."));
                _i = 0, sites_1 = sites;
                _a.label = 3;
            case 3:
                if (!(_i < sites_1.length)) return [3 /*break*/, 6];
                site = sites_1[_i];
                return [4 /*yield*/, InventoryItem_1.default.countDocuments({ siteId: site._id })];
            case 4:
                count = _a.sent();
                console.log("Site: ".concat(site.name, " (ID: ").concat(site._id, ") - Inventory Items: ").concat(count));
                _a.label = 5;
            case 5:
                _i++;
                return [3 /*break*/, 3];
