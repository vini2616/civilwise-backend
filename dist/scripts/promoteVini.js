...
var promoteVini = function () { return __awaiter(void 0, void 0, void 0, function () {
    var vini, viniLower, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                viniLower = _a.sent();
                if (!viniLower) return [3 /*break*/, 7];
                viniLower.permission = 'full_control';
                return [4 /*yield*/, viniLower.save()];
            case 6:
                _a.sent();
            ...
            case 8:
                error_1 = _a.sent();
                console.error("Error promoting user:", error_1);
                process.exit(1);
                return [3 /*break*/, 9];
