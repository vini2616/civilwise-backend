...
var ManpowerAttendanceSchema = new mongoose_1.Schema({
    siteId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Site', required: true },
    date: { type: String, required: true },
    records: [{
            manpowerId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Manpower' },
...
exports.default = mongoose_1.default.model('ManpowerAttendance', ManpowerAttendanceSchema);
